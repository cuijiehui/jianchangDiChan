...
public class Token {
    // 包名
    private static final String PACKAGE_NAME = "com.cui.android.jianchengdichan.model.model.";
    // 具体Model
    public static final String API_SPLASH_ADV = PACKAGE_NAME + "SplashAdvModel";
    public static final String API_LOGIN = PACKAGE_NAME + "LoginModel";
    public static final String API_REGISTER_CODE = PACKAGE_NAME + "RegisterCodeModel";
    ...
    public static final String API_RELEASE_ACT_MODEL= PACKAGE_NAME + "ReleaseActModel";
    ...
    public static final String API_PAY_ORDER_MODEL= PACKAGE_NAME + "PayOrderModel";
